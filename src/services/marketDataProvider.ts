import type { CompanyQualityEvaluation, FundamentalHistoryPoint, HistoricalPrice, SecFinancialQuarter, StockDataSources, StockFundamentals, StockQuote, StorageSource } from '../types'
