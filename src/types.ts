...
export interface StockSnapshot {
  ...
  historyComplete: boolean; priceHistory: HistoricalPrice[]; dataSource?: 'toss' | 'reference'; priceUpdatedAt?:string|null; priceState?:'live'|'close'|'failed'|'delayed'|'ip_changed';
