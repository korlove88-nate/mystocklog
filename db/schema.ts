...
export const marketDataSchemas = [
  ...
  `CREATE TABLE IF NOT EXISTS stock_snapshots (ticker TEXT NOT NULL, snapshot_date TEXT NOT NULL, price REAL, eps REAL, per REAL, market_cap REAL, drawdown_52w REAL, mdd_reference REAL, mdd_proximity REAL, ma20 REAL, ma60 REAL, ma120 REAL, ma200 REAL, price_stability TEXT, PRIMARY KEY (ticker, snapshot_date))`,
] as const
